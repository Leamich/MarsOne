...
def work_journal():
    ...
    users = list(map(lambda x: (x.name, x.surname), db_sess.query(User).all()))

    return render_template('works_journal.html', jobs=jobs)


def initiate_users(db_sess):
    db_sess.add(User(**{'surname': 'Scott',
                        'name': 'Ridley',
                        'age': 21,
                        'position': 'captain',
    ...
    db_sess.add(User(**{'surname': 'Stiles',
                        'name': 'Richard',
                        'age': 22,
                        'position': 'helper',
                        'speciality': 'general',
    ...
    db_sess.add(User(**{'surname': 'Crowds',
                        'name': 'Scott',
                        'age': 23,
    ...
    db_sess.add(User(**{'surname': 'Canon',
                        'name': 'Pictures',
                        'age': 24,
                        'position': 'operator',
                        'speciality': 'cinema',
    ...
    db_sess.add(User(**{'surname': 'Ronan',
                        'name': 'Warwar',
                        'age': 25,
                        'position': 'warior',
